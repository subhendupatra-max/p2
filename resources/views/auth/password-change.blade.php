                        ...
                        <div class="col-lg-6 col-md-6 col-12">
                            <div class="page-form-sec">
                                <form class="form w-100 formSubmit" novalidate="novalidate" id="kt_sign_in_form"
                                    action="{{ route('admin.reset.password') }}" method="POST">
                                    @csrf
                                    ...
                                    <div class="login-right">
                                        ...
                                        <div class="text-center mb-11">
                                            <h1 class="text-dark fw-bolder mb-3">Password Change</h1>
                                        </div>
                                        <div class="d-flex flex-column mb-8 fv-row">
                                            ...
                                            <input type="password" class="form-control form-control-solid"
                                                ...
                                                id="new_password" />
                                            <span style="color:red" style="font-size: 10px;">
                                        ...
                                        <div class="text-center pt-4">
                                            <button type="reset" id="admin_reset_password_form_cancel"
                                                class="btn btn-light me-3 mt-4"
                                                data-bs-dismiss="modal">Cancel</button>
                                            <button type="submit" id="admin_reset_password_form_submit"
