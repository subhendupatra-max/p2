                    ...
                    <div id="kt_app_content_container" class="app-container container-xxl">
                        <div class="card">
                            <div class="card-body p-0">
                                <div class="container">
                                    <form id="contentForm" action="{{ route('admin.content.add') }}" method="POST"
                                            ...
                                            <div class="col-md-2 pt-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="en_contant_writter_id"
                                                        class="form-control fromAlias select222" id="en_contant_writter_id">
                                            ...
                                            <div class="col-md-2 pt-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="hi_contant_writter_id"
                                                        class="form-control fromAlias select222" id="hi_contant_writter_id">
                                                        <option value="">--- select one ----</option>
                                            ...
                                            <div class="col-md-2 pt-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="contant_approver_id"
                                                        class="form-control fromAlias select222" id="contant_approver_id">
                                                        <option value="">--- select one ----</option>
                                            ...
                                            <div class="col-md-2 pt-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="contant_reviewer_id"
                                                        class="form-control fromAlias select222" id="contant_reviewer_id">
                                                        <option value="">--- select one ----</option>
                                            ...
                                            <div class="col-md-2 pt-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="hindi_approver_id"
                                                        class="form-control fromAlias select222" id="hindi_approver_id">
                                                        <option value="">--- select one ----</option>
                                            ...
                                            <div class="col-md-2 pt-4">
                                                <div class="form-group">
                                                    ...
                                                    <select name="hindi_reviewer_id"
                                                        class="form-control fromAlias select222" id="hindi_reviewer_id">
                                                        <option value="">--- select one ----</option>
                                        ...
                                        <div class="row taskSection">
                                            <div class="col-md-12 pt-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control fromAlias" name="task"
                                                        id="task" value="{{ $details->task ?? null }}">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="row align-items-end">
                                            ...
                                            <div class="col-md-3 pt-4">
                                                <div class="form-group">
                                                    ...
                                                    <input type="date" class="form-control fromAlias" name="date"
                                                        id="date" value="{{ $details->date ?? null }}">
                                                </div>
                                            </div>
                                            <div class="col-md-3 pt-4">
                                                <div class="form-group">
                                            ...
                                            <div class="col-md-8 m-auto text-center mb-5">
                                                <div class="fv-row">
                                                    ...
                                                    <div class="form-text"
                                                        ...
                                                        <p>Allowed file types: .png, .jpg, .jpeg, .pdf, .doc, .docx, .xls,
                                                            .xlsx, .csv</p>
                                                        <p>Max Size : 5mb</p>
                                                    </div>
                                                </div>
    ...
    <script src="{{ asset('assets/js/editor.js') }}"></script>
        <script>
            $(document).ready(function() {
                ...
                if ($('#need_content_writter').val() == 'no') {
